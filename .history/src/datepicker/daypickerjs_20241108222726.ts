...
function getdatesofFirstWeekISO(year: number) {
  ...
  if (fourthjanWEEKDAY == 0) {
    let firstMonday = `${year - 1}-11-29`;
    let firstTuesday = `${year - 1}-11-30`;
    let firstWednesday = `${year - 1}-11-31`;
    let firstThursday = `${year}-01-01`;
    let firstFriday = `${year}-01-02`;
    let firstSaturday = `${year}-01-03`;
    let firstSunday = `${year}-01-04`;
  ...
  if (fourthjanWEEKDAY == 1) {
    let firstMonday = `${year}-01-04`;
    let firstTuesday = `${year}-01-05`;
    let firstWednesday = `${year}-01-06`;
    let firstThursday = `${year}-01-07`;
    let firstFriday = `${year}-01-08`;
    let firstSaturday = `${year}-01-09`;
    let firstSunday = `${year}-01-10`;
  }
  if (fourthjanWEEKDAY == 2) {
    let firstMonday = `${year}-01-03`;
    let firstTuesday = `${year}-01-04`;
    let firstWednesday = `${year}-01-05`;
    let firstThursday = `${year}-01-06`;
    let firstFriday = `${year}-01-07`;
    let firstSaturday = `${year}-01-08`;
    let firstSunday = `${year}-01-09`;
  }
  if (fourthjanWEEKDAY == 3) {
    let firstMonday = `${year}-01-02`;
    let firstTuesday = `${year}-01-03`;
    let firstWednesday = `${year}-01-04`;
    let firstThursday = `${year}-01-05`;
    let firstFriday = `${year}-01-06`;
    let firstSaturday = `${year}-01-07`;
    let firstSunday = `${year}-01-08`;
  }
  if (fourthjanWEEKDAY == 4) {
    let firstMonday = `${year}-01-01`;
    let firstTuesday = `${year}-01-02`;
    let firstWednesday = `${year}-01-03`;
    let firstThursday = `${year}-01-04`;
    let firstFriday = `${year}-01-05`;
    let firstSaturday = `${year}-01-06`;
    let firstSunday = `${year}-01-07`;
  }
  if (fourthjanWEEKDAY == 5) {
    let firstMonday = `${year - 1}-12-31`;
    let firstTuesday = `${year}-01-01`;
    let firstWednesday = `${year}-01-02`;
    let firstThursday = `${year}-01-03`;
    let firstFriday = `${year}-01-04`;
    let firstSaturday = `${year}-01-05`;
    let firstSunday = `${year}-01-06`;
  }
  if (fourthjanWEEKDAY == 6) {
    let firstMonday = `${year - 1}-12-30`;
    let firstTuesday = `${year - 1}-12-31`;
    let firstWednesday = `${year}-01-01`;
    let firstThursday = `${year}-01-02`;
    let firstFriday = `${year}-01-03`;
    let firstSaturday = `${year}-01-04`;
    let firstSunday = `${year}-01-05`;
