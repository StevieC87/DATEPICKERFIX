...
//GET array of dates FOR WEEK X of YEAR x
function GetArrayofDatesbyByWeekNumberNYear(weeknumber: number, year: number) {
...
function getdatesofWeekbynumberAndYear(weeknumber: number, year: number) {
  ...
  if (weeknumber === 1) {
    ...
    let firstMondayofWeekNu = GetArrayofDatesbyByWeekNumberNYear(weeknumber, year);
  }
