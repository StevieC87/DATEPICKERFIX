...
function getdatesofFirstWeekISO(year: number) {
  ...
  if (fourthjanWEEKDAY == 6) {
    ...
    let firstTuesday = `${year - 1 }-12-07`;
    let firstWednesday = `${year}-01-08`;
    let firstThursday = `${year}-01-09`;
    let firstFriday = `${year}-01-10`;
    let firstSaturday = `${year}-01-11`;
    let firstSunday = `${year}-01-12`;
  }
