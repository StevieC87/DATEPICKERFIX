...
function getdatesofFirstWeekISO(year: number) {
  ...
  if (fourthjanWEEKDAY == 5) {
    let firstMonday = `${year}-01-07`;
    let firstTuesday = `${year}-01-08`;
    let firstWednesday = `${year}-01-09`;
    let firstThursday = `${year}-01-10`;
    let firstFriday = `${year}-01-11`;
    let firstSaturday = `${year}-01-12`;
    let firstSunday = `${year}-01-13`;
  }
  if (fourthjanWEEKDAY == 6) {
    let firstMonday = `${year}-01-06`;
